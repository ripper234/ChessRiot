...
import { CHESS_PIECE_NAMES, isDarkSquare, orientedBoardSquares } from "@/lib/game-presentation";
...
export function CaptureLab() {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(
      () => setRunning(false),
      reducedMotion ? 120 : ANIMATION_MS,
    );
    return () => window.clearTimeout(timer);
  }, [reducedMotion, run, running]);
    ...
    <main className="capture-lab-shell">
      ...
      <section className="capture-lab-layout">
        <div className="capture-lab-copy">
          <span className="eyebrow">BRANCH-ONLY ANIMATION LAB</span>
          <h1>CAPTURES<br /><em>FIGHT BACK.</em></h1>
          <p>
            Pick a piece and replay its real in-game capture action. No game state
        ...
        <div className="capture-lab-stage">
          ...
          <label className="capture-lab-motion">
            ...
            <span>
              ...
              <small>Final position plus a static capture marker.</small>
            </span>
          </label>
        </div>
      </section>
