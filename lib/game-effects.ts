...
export function moveBoardEffects(
  ...
  try {
    ...
    // Animation is presentation-only. If an older or malformed move cannot be
    // reconstructed safely, show the authoritative board without freezing it.
    return [];
  }
}
