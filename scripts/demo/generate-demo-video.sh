...
ffmpeg -y -hide_banner -loglevel error \
  ...
  -af "atempo=0.69,adelay=500,apad=whole_dur=90s" \
...
ffmpeg -y -hide_banner -loglevel error \
  -framerate 30 -loop 1 -t 10 -i "$asset_dir/home.jpg" \
  -framerate 30 -loop 1 -t 9 -i "$asset_dir/solo.jpg" \
  -framerate 30 -loop 1 -t 15 -i "$asset_dir/game.jpg" \
  -framerate 30 -loop 1 -t 13.5 -i "$asset_dir/themes.jpg" \
  -framerate 30 -loop 1 -t 12 -i "$asset_dir/game.jpg" \
  -framerate 30 -loop 1 -t 10.5 -i "$asset_dir/multiplayer.jpg" \
  -framerate 30 -loop 1 -t 10 -i "$asset_dir/invite-safe.jpg" \
  -framerate 30 -loop 1 -t 5.5 -i "$asset_dir/game.jpg" \
  -framerate 30 -loop 1 -t 4.5 -i "$asset_dir/home.jpg" \
  ...
  -filter_complex "\
    ...
    [rawvideo]subtitles='$asset_dir/captions.vtt':force_style='FontName=DejaVu Sans,FontSize=18,Bold=1,PrimaryColour=&H00FFFFFF,OutlineColour=&HCC071019,BorderStyle=3,BackColour=&H90071019,Outline=1,Shadow=0,MarginV=24,Alignment=2'[video];\
