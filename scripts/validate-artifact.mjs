...
assert.equal(status.releases[0].version, "0.3.5");
...
assert.deepEqual(
  ...
  [
    { key: "development", deployedVersion: "0.3.5" },
...
assert.equal(persisted.latestVersion, "0.3.5");
...
assert.equal(promoted.latestVersion, "0.3.5");
